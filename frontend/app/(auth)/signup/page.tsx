...
function SignupInner() {
  ...
  const [mode, setMode] = useState<\"signup\" | \"login\">(() => {
    const m = params?.get?.(\"mode\") as string | null
                  ...
                  <div className=\"space-y-2\">
                    ...
                    <div className=\"relative\">
                      ...
                      <Input
                        ...
                        className=\"h-11 bg-slate-800/50 border-slate-700/50 pl-10 text-slate-200 placeholder:text-slate-500 transition-colors focus:border-violet-500/50 focus:ring-violet-500/20\"
                        required
                        disabled={submitting}
                      />
                    </div>
                  ...
                  <div className=\"space-y-2\">
                    ...
                    <div className=\"relative\">
                      ...
                      <Input
                        ...
                        onKeyUp={(e: any) =>
                          setCapsLock(Boolean(e.getModifierState && e.getModifierState(\"CapsLock\")))
                        }
                        className=\"h-11 bg-slate-800/50 border-slate-700/50 pl-10 pr-10 text-slate-200 placeholder:text-slate-500 transition-colors focus:border-violet-500/50 focus:ring-violet-500/20\"
                        required
                        disabled={submitting}
                      />
                      <button
